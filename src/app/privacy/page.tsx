...
export const metadata = {
  ...
  description: 'Політика конфіденційності та захисту персональних даних відповідно до GDPR. Draft2Live.',
};
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-8 text-text-secondary text-[15px] leading-relaxed">
            ...
            <section>
              ...
              <div className="mt-3 p-4 rounded-xl bg-white/5 border border-border">
              ...
              <p className="mt-3 text-sm text-text-muted">З питань захисту персональних даних ви можете звернутись до нас за адресою <a href="mailto:info@draft2live.ai" className="text-primary hover:underline">info@draft2live.ai</a>.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-white mb-3">3. Які дані ми збираємо</h2>

              <h3 className="text-white font-medium mt-4 mb-2">3.1. Дані, які ви надаєте безпосередньо</h3>
              ...
              <h3 className="text-white font-medium mt-4 mb-2">3.2. Дані, що збираються автоматично</h3>
              <ul className="list-disc list-inside space-y-1.5">
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <p className="text-white font-medium mb-1">Виконання договору (ст. 6(1)(b) GDPR)</p>
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <p className="text-white font-medium mb-1">Законний інтерес (ст. 6(1)(f) GDPR)</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <p className="text-white font-medium mb-1">Згода (ст. 6(1)(a) GDPR)</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <p className="text-white font-medium mb-1">Юридичний обовʼязок (ст. 6(1)(c) GDPR)</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <section>
              ...
              <div className="mt-4 space-y-4">
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Інфраструктура та хостинг</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">AI-сервіси</h3>
                  <p className="text-sm mb-2">Платформа використовує <strong className="text-white">OpenRouter, Inc.</strong> (США) як єдиний API-шлюз для доступу до моделей штучного інтелекту. Через OpenRouter ваш контент може оброблятись такими провайдерами:</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">AI-детекція та якість контенту</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Обробка медіа</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">SEO та аналіз контенту</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Платежі</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Аналітика та маркетинг</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                  ...
                  <p className="text-sm mt-2">Ці сервіси використовують cookies. Детальніше — у нашій <Link href="/cookies" className="text-primary hover:underline">Політиці cookies</Link>.</p>
                </div>

                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Сповіщення</h3>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-border">
                  <h3 className="text-white font-medium mb-2">Опціональні інтеграції (за вибором Користувача)</h3>
                  <p className="text-sm mb-2">Наступні сервіси активуються лише якщо Користувач самостійно підключає власний API-ключ. У такому разі Користувач вступає в прямі договірні відносини з відповідним постачальником:</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <div className="mt-6 p-4 rounded-xl bg-amber-500/5 border border-amber-500/20">
                <h3 className="text-white font-medium mb-2">Важливе застереження щодо сторонніх сервісів</h3>
                <p className="text-sm">Ми передаємо стороннім постачальникам лише ті дані, які необхідні для виконання конкретної функції (принцип мінімізації даних, ст. 5(1)(c) GDPR). <strong className="text-white">Ми не зберігаємо дані від імені сторонніх постачальників і не контролюємо їхні процеси обробки даних після передачі.</strong></p>
                <p className="text-sm mt-2">Кожен сторонній постачальник є незалежним контролером або процесором даних і діє відповідно до власної політики конфіденційності. Зокрема, але не виключно:</p>
                ...
                <p className="text-sm mt-2"><strong className="text-white">Оператор не несе відповідальності за практики обробки персональних даних сторонніми постачальниками</strong> після належної передачі даних відповідно до умов DPA. Ми рекомендуємо ознайомитись з їхніми політиками конфіденційності.</p>
              </div>
            ...
            <section>
              ...
              <p>Ми зберігаємо ваші персональні дані лише стільки, скільки це необхідно для досягнення цілей, зазначених у цій Політиці:</p>
              <ul className="list-disc list-inside mt-3 space-y-1.5">
            ...
            <section>
              ...
              <div className="mt-4 space-y-3">
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на доступ</strong> (ст. 15 GDPR) — отримати копію ваших персональних даних, які ми обробляємо</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на виправлення</strong> (ст. 16 GDPR) — виправити неточні або неповні дані</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на видалення</strong> (ст. 17 GDPR) — вимагати видалення ваших даних (&laquo;право бути забутим&raquo;)</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на обмеження обробки</strong> (ст. 18 GDPR) — обмежити обробку ваших даних за певних обставин</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на перенесення даних</strong> (ст. 20 GDPR) — отримати дані у структурованому, машиночитаному форматі</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право на заперечення</strong> (ст. 21 GDPR) — заперечити проти обробки даних на основі законного інтересу</p>
                </div>
                <div className="p-3 rounded-lg bg-white/5 border border-border">
                  <p><strong className="text-white">Право відкликати згоду</strong> (ст. 7(3) GDPR) — відкликати раніше надану згоду в будь-який момент</p>
                </div>
              </div>
            ...
            <section>
              ...
              <p>Ми застосовуємо відповідні технічні та організаційні заходи для захисту ваших даних, включаючи:</p>
              <ul className="list-disc list-inside mt-3 space-y-1.5">
            ...
            <section>
              ...
              <p>З питань конфіденційності та захисту даних:</p>
